...
// Función para calcular la recaudación de un evento
...
// Función para procesar un evento y actualizar las estadísticas si la fecha es mayor que la actual
...
// Función para procesar un evento y actualizar las estadísticas si la fecha es menor que la actual
...
// Función principal para calcular estadísticas de categoría con fecha mayor que la actual
function calculateCategoryStatisticsForFutureEvents(data, priceAttribute, assistanceAttribute, categoryAttribute, capacityAttribute, currentDate) {
    ...
    // Calcular el porcentaje de asistencia para cada categoría
...
// Función principal para calcular estadísticas de categoría con fecha menor que la actual
